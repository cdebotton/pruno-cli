  ...
  return program.command("new").description("Initialize Pruno for this project.").alias("n").action(function () {
    ...
    inquirer.prompt([{
      ...
      if (params.koa) {
        ...
        save(["koa", "koa-json", "koa-compress", "koa-bodyparser", "koa-json", "koa-static", "koa-isomorphic", "koa-router", "koa-mount", "require-dir", "react-router", "alt"]);
      }
      ...
      if (params.db) {
        ...
        save(["sequelize", "sequelize-cli", "yaml-env-config", "object-assign", "babel"]);
